...
Section:NewButton("Shift", "ButtonInfo", function()
https://raw.githubusercontent.com/MiniNoobie/ShiftLockx/main/Shiftlock-MiniNoobie
end)
...
Section:NewButton("Fake Korblox", "ButtonInfo", function()
